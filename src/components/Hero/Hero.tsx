                ...
                <div className="bg-gray-800 border border-gray-800 shadow-lg  rounded-2xl p-4">
                    <div className="flex-none sm:flex">
                        <div className=" relative h-32 w-32   sm:mb-0 mb-3">
                            <img src="https://tailwindcomponents.com/storage/avatars/njkIbPhyZCftc4g9XbMWwVsa7aGVPajYLRXhEeoo.jpg" alt="Gabriel" className=" w-32 h-32 object-cover rounded-2xl" />
                            <a href="#" className="absolute -right-2 bottom-2   -ml-3  text-white p-1 text-xs bg-green-600 hover:bg-green-500 font-medium tracking-wider rounded-full transition ease-in duration-300">
                        ...
                        <div className="flex-auto sm:ml-5 justify-evenly">
                            <div className="flex items-center justify-between sm:mt-2">
                                <div className="flex items-center">
                                    <div className="flex flex-col">
                                        <div className="w-full flex-none text-lg text-gray-200 font-bold leading-none">Gabriel Porto</div>
                                        <div className="flex-auto text-gray-400 my-1">
                                            <span className="mr-3 ">Desenvolvedor e Analista de Sistemas</span><span className="mr-3 border-r border-gray-600  max-h-0"></span><span>Fortaleza, CE</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-row items-center">
                                ...
                                <div className="flex-1 inline-flex   items-center ml-2 space-x-2">
                                    <a href="https://www.behance.net/ajeeshmon" target="_blank"><svg className=" cursor-pointer w-9 h-9 p-1  rounded-2xl hover:bg-blue-500 hover:text-white transition ease-in duration-300" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 50 50" >
                                    ...
                                    <a href="https://www.linkedin.com/in/ajeeshmon" target="_blank"><svg className="cursor-pointer w-9 h-9 p-1  rounded-2xl hover:bg-blue-500 hover:text-white transition ease-in duration-300" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 172 172" >
                                        <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" className="mix-blend-mode: normal">
                                            <path d="M0,172v-172h172v172z" fill="none"></path>
                                            <g fill="#ffffff">
                            ...
                            <div className="flex pt-2  text-sm text-gray-400">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <p className="">3 Projetos</p>
                                </div>
                                <a href="https://www.behance.net/ajeeshmon" target="_blank" className="flex-no-shrink bg-green-400 hover:bg-green-500 px-5 ml-4 py-2 text-xs shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-green-300 hover:border-green-500 text-black rounded-full transition ease-in duration-300">Confira!</a>
                            </div>
                        </div>
                    </div>
                </div>
